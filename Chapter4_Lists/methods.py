print("Methods - Lesson 15 - Methods and the index(), append(), insert(), remove(), sort() List Methods")
print("Youtube URL -  https://youtu.be/Z9IxxW7428A")
...
Rather, the list is modified in place. Modifying a list in place is covered in more detail later in Mutable and Immutable Data Types.
...
spam = ['hello', 'hi', 'howdy', 'heyas']
print("The index of hello is ", + spam.index('hello'))
